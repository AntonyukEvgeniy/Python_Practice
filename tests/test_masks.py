...
@pytest.mark.parametrize("card_number,expected",[(2202208131326309,"2202 20** **** 6309"),(1111222233334444,"1111 22** **** 4444"),("0000000000000000","0000 00** **** 0000")])
...
@pytest.mark.parametrize("bank_account_number,expected",[("73654108430135874305","**4305"),("00000000000000000000000000","**0000")])
